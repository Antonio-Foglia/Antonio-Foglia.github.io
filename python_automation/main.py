...
print('Sucesfully made {}!\n'.format(destination_dir))

particles = r"particles"
destination_particles = r"{}_particles/particles".format(s)
shutil.copytree(particles, destination_particles)
print('Sucesfully moved particles inside of {}!\n'.format(destination_dir))
...
for curr_file in html_files:
  ...
  if no_footer in filedata:
      print('Footer succesfully removed in {}!\n'.format(curr_file))
  else:
      print('Error: footer NOT removed in {}!\n'.format(curr_file))
  ...
  if new_section_with_particles in filedata:
      print('Particles succesfully added in {}!\n'.format(curr_file))
  else:
      print('Error: particles NOT added in {}!\n'.format(curr_file))
...
'''
  ...
  print('My style succesfully appended in {}!\n'.format(curr_file))
